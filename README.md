...
**DISCLAIMER**: This tool is a proof of cocept implementation for research purposes and **not to be used in any kind of real work**. See the accompanying blog post [here](https://blog.fraktal.fi/testing-ai-orchestrated-attacks-in-practice-12f8fb03191e). 
